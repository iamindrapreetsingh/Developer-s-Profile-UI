...
class GetModal extends Component {
  ...
  async fetchUsers() {
    const response = await fetch("https://adevelopersprofile.onrender.com/api/developers");
  ...
  submitHandler = (e) => {
    ...
    axios
      .post("https://adevelopersprofile.onrender.com/api/developers", requestPayload)
      .then((response) => {
